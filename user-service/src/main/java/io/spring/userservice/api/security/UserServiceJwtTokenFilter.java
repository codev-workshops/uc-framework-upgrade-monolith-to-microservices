...
public class UserServiceJwtTokenFilter extends OncePerRequestFilter {
  private final UserRepository userRepository;
  private final JwtService jwtService;
  private final String header = "Authorization";

  public UserServiceJwtTokenFilter(UserRepository userRepository, JwtService jwtService) {
